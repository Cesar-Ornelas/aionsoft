...
- Add the Review tab with saved-version text anchors, flat comments, deep links, stale-anchor fallback, and optional Operations Issue handoff. Implementation plan: `plans/document-review-and-comments.md`.
